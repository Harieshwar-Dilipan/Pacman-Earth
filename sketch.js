...
function preload(){
  bg=loadImage("./bg.jpg");
  pacmanImage=loadAnimation("./3.png")
//  pUp=loadAnimation("./assets/pacmanAnim.gif");
  potionOfSwift=loadImage("./potionOfSwiftness.png");
  potionOfHeal=loadImage("./PotionOfHealing.png");
  potionOfPower=loadImage("./PotionOfStrength.png");
  heartImage=loadImage("./Life.png");
  hungerImage=loadImage("./hungerBar.png")
  emptyHeartImg=loadImage("./emptyHeart.png");
  ghostImg=loadAnimation("./ghost.gif");
  spawnerImg=loadImage("./spawner.png");
  carrotImg=loadImage("./carrot.png");
  boneImg=loadImage("./bone.png");
  enchantedImg=loadImage("./enchantedFood.gif");
  emptyHunger=loadImage("./emptyHunger.png");
  portal204=loadImage("./portal.png")
}
...
function portal(){
    if(pacman.isTouching(portal204)){
        pacman.x=204;
        pacman.y=305;
    }
}
